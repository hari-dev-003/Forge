...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen grid place-items-center bg-bg relative overflow-hidden px-6">
      ...
      <Reveal as="div" className="relative z-10 text-center bg-surface/70 backdrop-blur-md border border-border rounded-shell px-10 py-12 max-w-105 shadow-card">
        ...
        <h1 className="text-display-xl leading-none font-bold font-heading tracking-tight text-white">
